...
void EmptyLinkFunctionForGeneratedCodeAutoChess_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_AutoChess()
	{
		if (!Z_Registration_Info_UPackage__Script_AutoChess.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_AAutoChessGameState_OnRevivalUpdate__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_AutoChess(Z_Construct_UPackage__Script_AutoChess, TEXT("/Script/AutoChess"), Z_Registration_Info_UPackage__Script_AutoChess, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x02113452, 0x831718D1));
